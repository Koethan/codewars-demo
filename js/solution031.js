...
function birdCode(arr){
    ...
    let abbrev = []
    arr.forEach( (bird) => {
      let separated = bird.replaceAll('-','$').replaceAll('/','$').replaceAll(' ','$').split('$')
      answer.push(separated)
      
    })
    answer.forEach( (bird) => {
        if (bird.length === 1){
            abbrev.push(`${bird[0][0].toUpperCase()}${bird[0][1].toUpperCase()}${bird[0][2].toUpperCase()}${bird[0][3].toUpperCase()}`)
        }
        else if (bird.length === 2){
            abbrev.push(`${bird[0][0].toUpperCase()}${bird[0][1].toUpperCase()}${bird[1][0].toUpperCase()}${bird[1][1].toUpperCase()}`)
        }
        else if (bird.length === 3){
            abbrev.push(`${bird[0][0].toUpperCase()}${bird[1][0].toUpperCase()}${bird[2][0].toUpperCase()}${bird[2][1].toUpperCase()}`)
        }
        else if (bird.length === 4){
            abbrev.push(`${bird[0][0].toUpperCase()}${bird[1][0].toUpperCase()}${bird[2][0].toUpperCase()}${bird[3][0].toUpperCase()}`)
        }
    })
    return abbrev
...
console.log(birdCode(['Black-Capped Chickadee', 'Common Tern', 'Robin']))
